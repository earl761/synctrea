<footer class="bg-gray-900">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
                ...
                <ul class="mt-4 space-y-4">
                    <li><a href="{{ route('home') }}#features" class="text-base text-gray-300 hover:text-white">Features</a></li>
                    <li><a href="{{ route('home') }}#suppliers" class="text-base text-gray-300 hover:text-white">Suppliers</a></li>
        ...
        <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">&copy; {{ date('Y') }} {{ config('app.name') }}. All rights reserved.</p>
        </div>
    </div>
</footer>